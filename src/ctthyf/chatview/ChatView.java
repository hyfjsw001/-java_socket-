...
public class ChatView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ip.setFont(new java.awt.Font("宋体", 0, 14)); // NOI18N
        ip.setText("192.168.123.97");
    ...
    private void fasongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fasongActionPerformed
            String text=sendtext.getText().trim();
            String address=ip.getText().trim();
        if(address==null){
            JOptionPane.showMessageDialog(this, "请先输入ip");
            ip.setText("");
	...
	String date=sdf.format(d);
         String s1=("from"+address+"("+date+"):"+"\n"+"  "+text+"\n");
           new SendThread(s1, address).start();
             history.append("我："+text+"\n");
             sendtext.setText("");
        }else{
            JOptionPane.showMessageDialog(this, "发送内容不能为空");
        }
        
    }//GEN-LAST:event_fasongActionPerformed
